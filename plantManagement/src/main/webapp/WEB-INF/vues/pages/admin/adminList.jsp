...
<head>
  ...
  <title>Plant Management Admin</title>
  <!-- plugins:css -->
                ...
                <div class="card-body">
                    <div style="display:flex; align-items:center; justify-content: space-between; padding-bottom: 20px;">
                        <h2 style="display:flex; align-items:center; justify-content:center">
                          <i class="mdi mdi mdi-account menu-icon"style="margin-right: 5px;"></i> Admins</h2>
                          <a href="/app/admin/add" style="text-decoration: none;">
