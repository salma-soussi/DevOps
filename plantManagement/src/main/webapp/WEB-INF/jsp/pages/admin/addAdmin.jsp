                ...
                <div class="card">
                  <div class="card-body">
                    <h2 style="display:flex; align-items:center; margin-bottom: 30px;">
                        <i class="mdi mdi mdi-account menu-icon"style="margin-right: 5px;"></i> Add new admin</h2>
                    <form class="forms-sample"  action="/app/admin/save" method=post enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">First name</label>
                        <input type="text" class="form-control" name="name" id="exampleInputName1" placeholder="First name" required value="${user.name}">
                      </div>
                      <div class="form-group">
                      ...
                      <input type=hidden name=id value="${address.idA}">
